...
wl=[]
# member---------------------------
query_old = '(project = PS AND issuetype = "Engineering card" AND status in (Open, "In Progress", Reopened, TODO) AND component = "Member Build") OR (project = PS AND issuetype = "Engineering card" AND resolved >= 2015-01-01 AND component = "Member Build")'
...
# member---------------------------
query_old = '(project = PS AND issuetype = "Engineering card" AND status in (Open, "In Progress", Reopened, TODO) AND component = "96Boards") OR (project = PS AND issuetype = "Engineering card" AND resolved >= 2015-01-01 AND component = "96Boards")'
all_old = jira_old.search_issues(query_old)
report = Report(jira_old)
w_2 = len(all_old)
wl.append(w_2)
...
# member---------------------------
query_old = '(project = PS AND issuetype = "Engineering card" AND status in (Open, "In Progress", Reopened, TODO) AND component = "Engineering works") OR (project = PS AND issuetype = "Engineering card" AND resolved >= 2015-01-01 AND component = "Engineering works")'
all_old = jira_old.search_issues(query_old)
report = Report(jira_old)
w_3 = len(all_old)
wl.append(w_3)
...
# member---------------------------
query_old = '(project = PS AND issuetype = "Engineering card" AND status in (Open, "In Progress", Reopened, TODO) AND component = "LAVA") OR (project = PS AND issuetype = "Engineering card" AND resolved >= 2015-01-01 AND component = "LAVA")'
all_old = jira_old.search_issues(query_old)
report = Report(jira_old)
w_4 = len(all_old)
wl.append(w_4)
...
# member---------------------------
query_old = '(project = PS AND issuetype = "Engineering card" AND status in (Open, "In Progress", Reopened, TODO) AND component = "Training") OR (project = PS AND issuetype = "Engineering card" AND resolved >= 2015-01-01 AND component = "Training")'
all_old = jira_old.search_issues(query_old)
report = Report(jira_old)
w_5 = len(all_old)
wl.append(w_5)
...
plt.axis('equal')
plt.text(0.6, -1.2, 'Period: Feb-Sep 2015', color='black', fontsize=14)#, fontweight='bold')
