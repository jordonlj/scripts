...
query = 'project = PSE AND issuetype = "Epic" AND component = "Member Build"'
...
# member---------------------------
query_old = 'project = PS AND issuetype = "Engineering card" AND status in (Resolved, Closed) AND component = 96Boards'
all_old = jira_old.search_issues(query_old)
query = 'project = PSE AND issuetype = "Epic" AND component = "96Boards"'
all = jira.search_issues(query)
report = Report(jira)
...
# member---------------------------
query_old = 'project = PS AND issuetype = "Engineering card" AND status in (Resolved, Closed) AND component = "Engineering works"'
all_old = jira_old.search_issues(query_old)
query = 'project = PSE AND issuetype = "Epic" AND component = "Engineering works"'
all = jira.search_issues(query)
report = Report(jira)
...
# member---------------------------
query_old = 'project = PS AND issuetype = "Engineering card" AND status in (Resolved, Closed) AND component = LAVA'
all_old = jira_old.search_issues(query_old)
query = 'project = PSE AND issuetype = "Epic" AND component = "LAVA"'
all = jira.search_issues(query)
report = Report(jira)
...
# member---------------------------
query_old = 'project = PS AND issuetype = "Engineering card" AND status in (Resolved, Closed) AND component = Training'
all_old = jira_old.search_issues(query_old)
query = 'project = PSE AND issuetype = "Epic" AND component = "Training"'
all = jira.search_issues(query)
report = Report(jira)
...
# member---------------------------
query = 'project = PSE AND issuetype = "Epic" AND component = "BSP Analysis"'
all = jira.search_issues(query)
report = Report(jira)
w_6 = len(all)
wl.append(w_6)
...
plt.axis('equal')
plt.text(0.6, -1.2, 'PSE Card summary by Service', color='black', fontsize=14)#, fontweight='bold')
