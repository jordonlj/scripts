...
wl=[]
# member---------------------------
query_old = 'project = PS AND issuetype = "Engineering card" AND status in (Resolved, Closed) AND component = "Actions"'
all_old = jira_old.search_issues(query_old)
query = 'project = PSE AND issuetype = "Epic" AND component = "Actions"'
all = jira.search_issues(query)
report = Report(jira)
w_1 = len(all) + len(all_old)
wl.append(w_1)
...
# member---------------------------
query_old = 'project = PS AND issuetype = "Engineering card" AND status in (Resolved, Closed) AND component = Hisilicon'
all_old = jira_old.search_issues(query_old)
query = 'project = PSE AND issuetype = "Epic" AND component = "Hisilicon"'
all = jira.search_issues(query)
report = Report(jira)
w_2 = len(all) + len(all_old)
wl.append(w_2)
report.print('[Jason] member******************************')
...
# member---------------------------
query_old = 'project = PS AND issuetype = "Engineering card" AND status in (Resolved, Closed) AND component = "Linaro"'
all_old = jira_old.search_issues(query_old)
query = 'project = PSE AND issuetype = "Epic" AND component = "Linaro"'
all = jira.search_issues(query)
report = Report(jira)
w_3 = len(all) + len(all_old)
wl.append(w_3)
report.print('[Jason] member******************************')
...
# member---------------------------
query_old = 'project = PS AND issuetype = "Engineering card" AND status in (Resolved, Closed) AND component = MediaTek'
all_old = jira_old.search_issues(query_old)
query = 'project = PSE AND issuetype = "Epic" AND component = "MediaTek"'
all = jira.search_issues(query)
report = Report(jira)
w_4 = len(all) + len(all_old)
wl.append(w_4)
report.print('[Jason] member******************************')
...
# member---------------------------
query_old = 'project = PS AND issuetype = "Engineering card" AND status in (Resolved, Closed) AND component = Qualcomm'
all_old = jira_old.search_issues(query_old)
query = 'project = PSE AND issuetype = "Epic" AND component = "Qualcomm"'
all = jira.search_issues(query)
report = Report(jira)
w_5 = len(all) + len(all_old)
wl.append(w_5)
report.print('[Jason] member******************************')
...
# member---------------------------
query_old = 'project = PS AND issuetype = "Engineering card" AND status in (Resolved, Closed) AND component = Spreadtrum'
all_old = jira_old.search_issues(query_old)
query = 'project = PSE AND issuetype = "Epic" AND component = "Spreadtrum"'
all = jira.search_issues(query)
report = Report(jira)
w_6 = len(all) + len(all_old)
wl.append(w_6)
report.print('[Jason] member******************************')
...
# member---------------------------
query_old = 'project = PS AND issuetype = "Engineering card" AND status in (Resolved, Closed) AND component = TI'
all_old = jira_old.search_issues(query_old)
query = 'project = PSE AND issuetype = "Epic" AND component = "TI"'
all = jira.search_issues(query)
report = Report(jira)
w_7 = len(all) + len(all_old)
wl.append(w_7)
report.print('[Jason] member******************************')
...
# member---------------------------
query_old = 'project = PS AND issuetype = "Engineering card" AND status in (Resolved, Closed) AND component = ZTE'
all_old = jira_old.search_issues(query_old)
query = 'project = PSE AND issuetype = "Epic" AND component = "ZTE"'
all = jira.search_issues(query)
report = Report(jira)
w_8 = len(all) + len(all_old)
wl.append(w_8)
report.print('[Jason] member******************************')
...
plt.axis('equal')
plt.text(0.6, -1.2, 'PSE card summary by member', color='black', fontsize=14)#, fontweight='bold')
